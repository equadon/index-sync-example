...
"""Flask extension for Index Sync."""
...
class IndexSync(object):
    """Index Sync extension."""
    ...
    def init_app(self, app):
        ...
        app.extensions['index-sync'] = self
    ...
    def init_config(self, app):
        ...
        with_endpoints = app.config.get(
            'INDEX_SYNC_ENDPOINTS_ENABLED', True)
        for k in dir(config):
            if k.startswith('INDEX_SYNC_'):
