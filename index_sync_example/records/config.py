...
RECORDS_REST_ENDPOINTS = {
    'recid': dict(
        ...
        search_type=None,
        record_serializers={
            'application/json': ('index_sync_example.records.serializers'
                                 ':json_v1_response'),
        },
        search_serializers={
            'application/json': ('index_sync_example.records.serializers'
        ...
        record_loaders={
            'application/json': ('index_sync_example.records.loaders'
                                 ':json_v1'),
        },
        list_route='/records/',
...
"""REST API for index-sync-example."""
...
"""Records UI for index-sync-example."""
...
INDEX_SYNC_EXAMPLE_ENDPOINTS_ENABLED = True
