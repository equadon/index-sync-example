...
"""Flask extension for Index Sync Example."""
...
class IndexSyncExample(object):
    """Index Sync Example extension."""
    ...
    def init_app(self, app):
        ...
        app.extensions['index-sync-example'] = self
    ...
    def init_config(self, app):
        ...
        for k in dir(config):
            if k.startswith('INDEX_SYNC_EXAMPLE_'):
